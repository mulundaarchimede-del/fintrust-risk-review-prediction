...
Data Science track project for the AnalystLab Africa Experience Lab — a 4-week multidisciplinary program built around a fictional digital bank, FinTrust Digital Bank.

Disclaimer: FinTrust is a fictional organisation. All customers, transactions, labels and business information used in this project are synthetic and intended for educational purposes only.

Objective

Determine how machine learning can support FinTrust's risk-related decision-making by predicting whether a transaction should be flagged for risk review (Risk_Review_Flag) — a binary classification problem built on synthetic customer and transaction data.

Project Context

This repository documents the Data Science track contribution to the wider FinTrust Financial Intelligence & Digital Banking Support Solution, which also includes Data Analytics, ML Engineering, Generative AI and Project Management tracks.
...
Progress
 Week 1 — Understand & Plan: Predictive problem statement, target assessment, candidate feature table, hypotheses, initial modelling plan, data-quality observations.
